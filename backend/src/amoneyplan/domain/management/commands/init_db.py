...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--sample',
            action='store_true',
            help='Create a sample Money Plan for testing'
        )
    ...
    def _create_sample_plan(self):
        ...
        try:
            ...
            plan_id = service.create_plan(
                ...
                notes="Sample Money Plan for testing"
            )
            
            # Add some accounts and buckets
            checking_id = service.add_account(
                plan_id=plan_id,
            ...
            savings_id = service.add_account(
                plan_id=plan_id,
            ...
            self.stdout.write(self.style.SUCCESS(
                f"Created sample Money Plan with ID: {plan_id}"
            ))
